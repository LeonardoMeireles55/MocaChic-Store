...
function HeroSectionComponent({
  ...
  return (
    <section
      className="bg-[url('/images/simple_logo.png?height=1080&width=1920')] bg-cover bg-center py-24 md:py-36 relative overflow-hidden"
    ...
    >
      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="flex flex-col items-start space-y-8 text-left max-w-2xl animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-4 animate-slide-up" style={{ animationDelay: "0.3s" }}>
            <Link
...
const MemoizedHeroSection = memo(HeroSectionComponent)
