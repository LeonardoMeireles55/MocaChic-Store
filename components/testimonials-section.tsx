...
export function TestimonialsSection({ id, subtitle, title, testimonials }: Readonly<TestimonialsSectionProps>) {
  return (
    <section id={id} className="py-20 md:py-28 bg-white relative overflow-hidden">
