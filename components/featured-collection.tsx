...
export function FeaturedCollection({ products, whatsappLink, title }: Readonly<FeaturedCollectionProps>) {
  return (
      ...
      <div className="container px-4 md:px-6 relative z-10">
        ...
        <div className="flex flex-col items-center mb-16 animate-fade-in">
          ...
          <p className="text-stone-600 mt-6 text-center max-w-2xl">
            Descubra nossa coleção exclusiva de peças que combinam elegância atemporal com o máximo conforto para todas
            as ocasiões.
          </p>
        </div>
