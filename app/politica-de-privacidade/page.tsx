      ...
      <main className="flex-1">
        ...
        <div className="container mx-auto px-4 py-12 md:py-16">
          <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-6 md:p-10">
            <h1 className="text-3xl md:text-4xl font-serif font-bold text-amber-900 mb-8">Política de Privacidade</h1>

            <div className="prose prose-amber max-w-none">
              <p className="mb-4">Última atualização: {new Date().toLocaleDateString("pt-BR")}</p>

              <p className="mb-4">
                A Moça Chic Fortaleza está comprometida em proteger sua privacidade. Esta Política de Privacidade
                explica como coletamos, usamos, divulgamos, transferimos e armazenamos suas informações. Por favor,
                reserve um momento para se familiarizar com nossas práticas de privacidade.
              </p>

              <h2 className="text-2xl font-serif font-bold text-amber-800 mt-8 mb-4">Informações que coletamos</h2>

              <p className="mb-4">
                Podemos coletar vários tipos de informações quando você interage com nosso site, incluindo:
              </p>

              <ul className="list-disc pl-6 mb-6">
                <li>Informações pessoais como nome, endereço de e-mail, número de telefone e endereço de entrega</li>
              ...
              <h2 className="text-2xl font-serif font-bold text-amber-800 mt-8 mb-4">Como usamos suas informações</h2>
              ...
              <ul className="list-disc pl-6 mb-6">
                ...
                <li>Comunicar-nos com você sobre seus pedidos, produtos, serviços e ofertas promocionais</li>
              ...
              <h2 className="text-2xl font-serif font-bold text-amber-800 mt-8 mb-4">Seus direitos</h2>
              ...
              <p className="mb-4">
                ...
                contato conosco pelo e-mail mocachicfortaleza@gmail.com ou pelo WhatsApp (92) 99412-8570.
              </p>

              <h2 className="text-2xl font-serif font-bold text-amber-800 mt-8 mb-4">Alterações nesta política</h2>
              ...
              <p className="mt-8">Ao utilizar nosso site, você concorda com os termos desta Política de Privacidade.</p>
            </div>
